...
All grading for the course will be `r config::get("grading_model")`.

Students will NOT be assessed based on the success of the product, as this is not entirely within our control. Students will instead be assessed on the process in which they work to achieve the goals of the project. 

**Students will be assessed based on feedback from the faculty, the CBO, project peers, and self-assessment in the following areas:** 
