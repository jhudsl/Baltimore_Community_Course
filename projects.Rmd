...
- Keep the [dos and don'ts](https://source.jhu.edu/publications-and-resources/DosAndDontsOfPartnerships.pdf) in mind from [SOURCE](https://source.jhu.edu).
...
* **Infrastructure/Organization Lead** 
  - This student is in charge of organizing and maintaining a file structure for the documentation, notes, communication, code, etc. for the project. (We will provide [workflow suggestions](https://docs.google.com/document/d/1RveTbckBTomgx2JiiCbm01SE88OvODK7JCQxo1gbLbo/edit?usp=sharing) and require that groups use GitHub.) 
