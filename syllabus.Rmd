...
* **Date:** The course will meet on Fridays during `r config::get("terms")` (1.5 credits each term).  
...
- **How often will students and CBOs meet?** This depends on the project goals, but approximately 30 min - 1 hr every 2 weeks for the duration of the terms. Meetings will also be supplemented by emails. Keep in mind that CBO members are busy and staff may not be getting paid for their work.
- **Communication will mainly occur through Slack**. Instructors will email you about how to connect to Slack.**
